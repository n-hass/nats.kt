...
import dev.nhass.ktor.tls.openssl.ERR_error_string_n
import dev.nhass.ktor.tls.openssl.ERR_get_error
...
import dev.nhass.ktor.tls.openssl.SSL_ERROR_NONE
import dev.nhass.ktor.tls.openssl.SSL_ERROR_SSL
import dev.nhass.ktor.tls.openssl.SSL_ERROR_SYSCALL
import dev.nhass.ktor.tls.openssl.SSL_ERROR_WANT_READ
import dev.nhass.ktor.tls.openssl.SSL_ERROR_WANT_WRITE
import dev.nhass.ktor.tls.openssl.SSL_ERROR_ZERO_RETURN
import dev.nhass.ktor.tls.openssl.SSL_connect
import dev.nhass.ktor.tls.openssl.SSL_free
import dev.nhass.ktor.tls.openssl.SSL_get_error
import dev.nhass.ktor.tls.openssl.SSL_get_verify_result
import dev.nhass.ktor.tls.openssl.SSL_read
import dev.nhass.ktor.tls.openssl.SSL_shutdown
import dev.nhass.ktor.tls.openssl.SSL_write
import dev.nhass.ktor.tls.openssl.X509_verify_cert_error_string
